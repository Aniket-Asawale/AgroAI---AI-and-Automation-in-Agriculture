...
SAVE_PATH = r"C:\Users\jayes\plant_disease\models\efficientnet_b0_final.pth"
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            print(f"Saved best EfficientNet-B0 model: val_acc={val_acc:.4f}")
    ...
    print(f"EfficientNet-B0 Test accuracy: {t_correct / t_total:.4f}")
