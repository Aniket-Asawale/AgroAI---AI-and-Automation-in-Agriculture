...
SAVE_PATH = r"C:\Users\jayes\plant_disease\models\resnet18_final.pth"
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            print(f"Saved best ResNet18 model: val_acc={val_acc:.4f}")
    ...
    print(f"ResNet18 Test accuracy: {t_correct / t_total:.4f}")
