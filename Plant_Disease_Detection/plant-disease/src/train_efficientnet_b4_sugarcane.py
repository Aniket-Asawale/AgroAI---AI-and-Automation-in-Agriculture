...
CROP_NAME = "SUGARCANE"
DATA_ROOT = Path(r"C:\Users\jayes\plant_disease\data_sugarcane\images")
SAVE_PATH = r"C:\Users\jayes\plant_disease\models\efficientnet_b4_sugarcane.pth"
...
def main():
    ...
    print(f"[{CROP_NAME}] Test accuracy: {t_correct / t_total:.4f}")
